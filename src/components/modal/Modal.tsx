...
const Modal = ({ isOpen = false, onClose, children }: ModalProps) => {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as='div' className='relative z-50' onClose={onClose ? onClose : () => null}>
        <Transition.Child
          as={Fragment}
        ...
        <div className='fixed inset-0 z-10 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-4 text-center  sm:p-0'>
            ...
            >
              <Dialog.Panel className='relative w-full overflow-hidden rounded-lg bg-white px-4 pb-4 text-left  shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6'>
